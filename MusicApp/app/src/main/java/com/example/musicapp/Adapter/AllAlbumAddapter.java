...
public class AllAlbumAddapter extends RecyclerView.Adapter<AllAlbumAddapter.ViewHolder> {

    Context context;
    ArrayList<Album> albumArrayList;

    public AllAlbumAddapter(Context context, ArrayList<Album> albumArrayList) {
