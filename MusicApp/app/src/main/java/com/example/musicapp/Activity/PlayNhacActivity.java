...
public class PlayNhacActivity extends AppCompatActivity {
    ...
    SeekBar sktime;
    ImageButton imgplay,imgrepeat,imgmext,imgpre,imgrandom;
    ...
    private void eventClick() {
        ...
        imgrepeat.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(repeat == false){
                    if(checkrandom == true){
                        checkrandom = false;
                        imgrepeat.setImageResource(R.drawable.repeated);
        ...
        imgrandom.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(checkrandom == false){
                    if(repeat == true){
                        repeat = false;
                        imgrandom.setImageResource(R.drawable.shuffled);
                        imgrepeat.setImageResource(R.drawable.repeat);
                    }
                    imgrandom.setImageResource(R.drawable.shuffled);
                    checkrandom = true;
        ...
        imgmext.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(mangbaihat.size() > 0){
                ...
                imgmext.setClickable(false);
                Handler handler1 = new Handler();
                handler1.postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        imgpre.setClickable(true);
                        imgmext.setClickable(true);
                    }
                },500);
            }
        });
    ...
    private void init() {
        ...
        imgmext = findViewById(R.id.imagebuttonnext);
